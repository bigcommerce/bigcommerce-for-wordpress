...
var _values = _interopRequireDefault(__webpack_require__(34));
...
var createSpinLoader = function createSpinLoader() {
  ...
  var loader = tools.getNodes('.bc-load-items__loader', false, container, true)[0];
  var spinnerOptions = {
    opacity: 0.5,
    scale: 0.5,
    lines: 12
  };
  var spinner = new _spin.Spinner(spinnerOptions).spin(loader);

  if (spinner.el) {
    spinner.el.setAttribute('aria-label', _i18n.NLS.operations.loading);
  }
};
/**
...
if (__webpack_require__(39) && /./g.flags != 'g') __webpack_require__(83).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var createSpinner = function createSpinner() {
  ...
  var spinner = new _spin.Spinner(spinnerOptions).spin(el.spinner);
...
var init = function init() {
  ...
  GLOBALS.BANNERS.items.forEach(function (banner) {
    ...
    banners[banner.location] += (0, _banners.bannerContent)(banner.content, banner.name);
  });
...
var bannerContent = function bannerContent(content, label) {
  return "<aside class=\"bc-banner\" aria-label=\"".concat(label, "\">").concat(content, "</aside>");
};
