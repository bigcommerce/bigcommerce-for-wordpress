...
**option_values** | [**\BigCommerce\Api\v3\Model\OptionValueVariant[]**](OptionValueVariant.md) | Array of option and option values IDs that make up this variant. Will be empty if the variant is the product&#39;s base variant. | [optional] 
