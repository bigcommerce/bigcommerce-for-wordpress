...
class LineItemGiftCertificateRequestData implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['amount'] > 1000)) {
            $invalid_properties[] = "invalid value for 'amount', must be smaller than or equal to 1000.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 1000)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling LineItemGiftCertificateRequestData., must be smaller than or equal to 1000.');
        }
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling LineItemGiftCertificateRequestData., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Sets message
     * @param string $message Message shown to recipient, and provided by sender.
     * @return $this
     */
