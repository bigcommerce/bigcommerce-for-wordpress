...
class ErrorResponse implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'type' => 'string',
        'instance' => 'string',
        'errors' => '\BigCommerce\Api\v3\Model\DetailedErrors'
    );
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['instance'] = array_key_exists('instance', $data) ? $data['instance'] : new \stdClass();
    ...
    /**
     * Sets errors
     * @param \BigCommerce\Api\v3\Model\DetailedErrors $errors
     * @return $this
     */
