...
/**
 * ComplexRuleConditionPost Class Doc Comment
 *
 * @category    Class */
 // @description The model for a POST to create conditions on a complex rule.
/** 
 * @package     BigCommerce\Api\v3
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ComplexRuleConditionPost implements ArrayAccess
{
    /**
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['rule_id'] = array_key_exists('rule_id', $data) ? $data['rule_id'] : new \stdClass();
        $this->container['modifier_id'] = array_key_exists('modifier_id', $data) ? $data['modifier_id'] : new \stdClass();
        $this->container['modifier_value_id'] = array_key_exists('modifier_value_id', $data) ? $data['modifier_value_id'] : new \stdClass();
