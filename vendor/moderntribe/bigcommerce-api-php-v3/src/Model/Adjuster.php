...
class Adjuster implements ArrayAccess
{
    ...
    {
        $this->container['adjuster'] = array_key_exists('adjuster', $data) ? $data['adjuster'] : new \stdClass();
        $this->container['adjuster_value'] = array_key_exists('adjuster_value', $data) ? $data['adjuster_value'] : new \stdClass();
    }
    ...
    {
        $allowed_values = array('relative', 'percentage');
        if (!in_array($adjuster, $allowed_values)) {
