...
class OptionConfig implements ArrayAccess
{
    ...
    {
        $this->container['default_value'] = array_key_exists('default_value', $data) ? $data['default_value'] : new \stdClass();
        $this->container['checked_by_default'] = array_key_exists('checked_by_default', $data) ? $data['checked_by_default'] : new \stdClass();
        $this->container['checkbox_label'] = array_key_exists('checkbox_label', $data) ? $data['checkbox_label'] : new \stdClass();
        $this->container['date_limited'] = array_key_exists('date_limited', $data) ? $data['date_limited'] : new \stdClass();
        $this->container['date_limit_mode'] = array_key_exists('date_limit_mode', $data) ? $data['date_limit_mode'] : new \stdClass();
        $this->container['date_earliest_value'] = array_key_exists('date_earliest_value', $data) ? $data['date_earliest_value'] : new \stdClass();
        $this->container['date_latest_value'] = array_key_exists('date_latest_value', $data) ? $data['date_latest_value'] : new \stdClass();
        $this->container['file_types_mode'] = array_key_exists('file_types_mode', $data) ? $data['file_types_mode'] : new \stdClass();
        $this->container['file_types_supported'] = array_key_exists('file_types_supported', $data) ? $data['file_types_supported'] : new \stdClass();
        $this->container['file_types_other'] = array_key_exists('file_types_other', $data) ? $data['file_types_other'] : new \stdClass();
        $this->container['file_max_size'] = array_key_exists('file_max_size', $data) ? $data['file_max_size'] : new \stdClass();
        $this->container['text_characters_limited'] = array_key_exists('text_characters_limited', $data) ? $data['text_characters_limited'] : new \stdClass();
        $this->container['text_min_length'] = array_key_exists('text_min_length', $data) ? $data['text_min_length'] : new \stdClass();
        $this->container['text_max_length'] = array_key_exists('text_max_length', $data) ? $data['text_max_length'] : new \stdClass();
        $this->container['text_lines_limited'] = array_key_exists('text_lines_limited', $data) ? $data['text_lines_limited'] : new \stdClass();
        $this->container['text_max_lines'] = array_key_exists('text_max_lines', $data) ? $data['text_max_lines'] : new \stdClass();
        $this->container['number_limited'] = array_key_exists('number_limited', $data) ? $data['number_limited'] : new \stdClass();
        $this->container['number_limit_mode'] = array_key_exists('number_limit_mode', $data) ? $data['number_limit_mode'] : new \stdClass();
        $this->container['number_lowest_value'] = array_key_exists('number_lowest_value', $data) ? $data['number_lowest_value'] : new \stdClass();
        $this->container['number_highest_value'] = array_key_exists('number_highest_value', $data) ? $data['number_highest_value'] : new \stdClass();
        $this->container['number_integers_only'] = array_key_exists('number_integers_only', $data) ? $data['number_integers_only'] : new \stdClass();
        $this->container['product_list_adjusts_inventory'] = array_key_exists('product_list_adjusts_inventory', $data) ? $data['product_list_adjusts_inventory'] : new \stdClass();
        $this->container['product_list_adjusts_pricing'] = array_key_exists('product_list_adjusts_pricing', $data) ? $data['product_list_adjusts_pricing'] : new \stdClass();
        $this->container['product_list_shipping_calc'] = array_key_exists('product_list_shipping_calc', $data) ? $data['product_list_shipping_calc'] : new \stdClass();
    }
    ...
    {
        $allowed_values = array('earliest', 'range', 'latest');
        if (!in_array($date_limit_mode, $allowed_values)) {
    ...
    {
        $allowed_values = array('specific', 'all');
        if (!in_array($file_types_mode, $allowed_values)) {
    ...
    {
        $allowed_values = array('lowest', 'highest', 'range');
        if (!in_array($number_limit_mode, $allowed_values)) {
    ...
    {
        $allowed_values = array('none', 'weight', 'package');
        if (!in_array($product_list_shipping_calc, $allowed_values)) {
