...
class Product implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'bulk_pricing_rules' => '\BigCommerce\Api\v3\Model\BulkPricingRule[]',
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['calculated_price'] = array_key_exists('calculated_price', $data) ? $data['calculated_price'] : new \stdClass();
        $this->container['reviews_rating_sum'] = array_key_exists('reviews_rating_sum', $data) ? $data['reviews_rating_sum'] : new \stdClass();
        $this->container['reviews_count'] = array_key_exists('reviews_count', $data) ? $data['reviews_count'] : new \stdClass();
        $this->container['total_sold'] = array_key_exists('total_sold', $data) ? $data['total_sold'] : new \stdClass();
        $this->container['custom_fields'] = array_key_exists('custom_fields', $data) ? $data['custom_fields'] : new \stdClass();
        $this->container['bulk_pricing_rules'] = array_key_exists('bulk_pricing_rules', $data) ? $data['bulk_pricing_rules'] : new \stdClass();
        ...
        $this->container['images'] = array_key_exists('images', $data) ? $data['images'] : new \stdClass();
        $this->container['videos'] = array_key_exists('videos', $data) ? $data['videos'] : new \stdClass();
        $this->container['variants'] = array_key_exists('variants', $data) ? $data['variants'] : new \stdClass();
        $this->container['base_variant_id'] = array_key_exists('base_variant_id', $data) ? $data['base_variant_id'] : new \stdClass();
    }
     ...
     * @return \BigCommerce\Api\v3\Model\BulkPricingRule[]
     */
     ...
     * @param \BigCommerce\Api\v3\Model\BulkPricingRule[] $bulk_pricing_rules
     * @return $this
     */
    ...
    /**
     * Sets images
     * @param \BigCommerce\Api\v3\Model\ProductImage[] $images
     * @return $this
     */
    ...
    /**
     * Gets videos
     * @return \BigCommerce\Api\v3\Model\ProductVideo[]
     */
    ...
    /**
     * Sets videos
     * @param \BigCommerce\Api\v3\Model\ProductVideo[] $videos
     * @return $this
     */
    ...
    /**
     * Gets variants
     * @return \BigCommerce\Api\v3\Model\Variant[]
     */
    ...
    /**
     * Sets variants
     * @param \BigCommerce\Api\v3\Model\Variant[] $variants
     * @return $this
     */
