...
class Metafield implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['created_at'] = array_key_exists('created_at', $data) ? $data['created_at'] : new \stdClass();
        $this->container['updated_at'] = array_key_exists('updated_at', $data) ? $data['updated_at'] : new \stdClass();
    }
