...
class GiftCertificate implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['original_balance'] = array_key_exists('original_balance', $data) ? $data['original_balance'] : new \stdClass();
        $this->container['starting_balance'] = array_key_exists('starting_balance', $data) ? $data['starting_balance'] : new \stdClass();
        $this->container['remaining_balance'] = array_key_exists('remaining_balance', $data) ? $data['remaining_balance'] : new \stdClass();
