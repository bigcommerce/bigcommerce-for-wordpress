...
class ProductBase implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['sku'] = array_key_exists('sku', $data) ? $data['sku'] : new \stdClass();
        ...
        $this->container['width'] = array_key_exists('width', $data) ? $data['width'] : new \stdClass();
        $this->container['depth'] = array_key_exists('depth', $data) ? $data['depth'] : new \stdClass();
        $this->container['height'] = array_key_exists('height', $data) ? $data['height'] : new \stdClass();
        $this->container['price'] = array_key_exists('price', $data) ? $data['price'] : new \stdClass();
        $this->container['cost_price'] = array_key_exists('cost_price', $data) ? $data['cost_price'] : new \stdClass();
        $this->container['retail_price'] = array_key_exists('retail_price', $data) ? $data['retail_price'] : new \stdClass();
        $this->container['sale_price'] = array_key_exists('sale_price', $data) ? $data['sale_price'] : new \stdClass();
        $this->container['tax_class_id'] = array_key_exists('tax_class_id', $data) ? $data['tax_class_id'] : new \stdClass();
        $this->container['product_tax_code'] = array_key_exists('product_tax_code', $data) ? $data['product_tax_code'] : new \stdClass();
        $this->container['categories'] = array_key_exists('categories', $data) ? $data['categories'] : new \stdClass();
        $this->container['brand_id'] = array_key_exists('brand_id', $data) ? $data['brand_id'] : new \stdClass();
        $this->container['inventory_level'] = array_key_exists('inventory_level', $data) ? $data['inventory_level'] : new \stdClass();
        $this->container['inventory_warning_level'] = array_key_exists('inventory_warning_level', $data) ? $data['inventory_warning_level'] : new \stdClass();
        $this->container['inventory_tracking'] = array_key_exists('inventory_tracking', $data) ? $data['inventory_tracking'] : new \stdClass();
        $this->container['fixed_cost_shipping_price'] = array_key_exists('fixed_cost_shipping_price', $data) ? $data['fixed_cost_shipping_price'] : new \stdClass();
        $this->container['is_free_shipping'] = array_key_exists('is_free_shipping', $data) ? $data['is_free_shipping'] : new \stdClass();
        $this->container['is_visible'] = array_key_exists('is_visible', $data) ? $data['is_visible'] : new \stdClass();
        $this->container['is_featured'] = array_key_exists('is_featured', $data) ? $data['is_featured'] : new \stdClass();
        $this->container['related_products'] = array_key_exists('related_products', $data) ? $data['related_products'] : new \stdClass();
        $this->container['warranty'] = array_key_exists('warranty', $data) ? $data['warranty'] : new \stdClass();
        $this->container['bin_picking_number'] = array_key_exists('bin_picking_number', $data) ? $data['bin_picking_number'] : new \stdClass();
        $this->container['layout_file'] = array_key_exists('layout_file', $data) ? $data['layout_file'] : new \stdClass();
        $this->container['upc'] = array_key_exists('upc', $data) ? $data['upc'] : new \stdClass();
        $this->container['search_keywords'] = array_key_exists('search_keywords', $data) ? $data['search_keywords'] : new \stdClass();
        $this->container['availability'] = array_key_exists('availability', $data) ? $data['availability'] : new \stdClass();
        $this->container['availability_description'] = array_key_exists('availability_description', $data) ? $data['availability_description'] : new \stdClass();
        $this->container['gift_wrapping_options_type'] = array_key_exists('gift_wrapping_options_type', $data) ? $data['gift_wrapping_options_type'] : new \stdClass();
        $this->container['gift_wrapping_options_list'] = array_key_exists('gift_wrapping_options_list', $data) ? $data['gift_wrapping_options_list'] : new \stdClass();
        $this->container['sort_order'] = array_key_exists('sort_order', $data) ? $data['sort_order'] : new \stdClass();
        $this->container['condition'] = array_key_exists('condition', $data) ? $data['condition'] : new \stdClass();
        $this->container['is_condition_shown'] = array_key_exists('is_condition_shown', $data) ? $data['is_condition_shown'] : new \stdClass();
        $this->container['order_quantity_minimum'] = array_key_exists('order_quantity_minimum', $data) ? $data['order_quantity_minimum'] : new \stdClass();
        $this->container['order_quantity_maximum'] = array_key_exists('order_quantity_maximum', $data) ? $data['order_quantity_maximum'] : new \stdClass();
        $this->container['page_title'] = array_key_exists('page_title', $data) ? $data['page_title'] : new \stdClass();
        $this->container['meta_keywords'] = array_key_exists('meta_keywords', $data) ? $data['meta_keywords'] : new \stdClass();
        $this->container['meta_description'] = array_key_exists('meta_description', $data) ? $data['meta_description'] : new \stdClass();
        $this->container['view_count'] = array_key_exists('view_count', $data) ? $data['view_count'] : new \stdClass();
        $this->container['preorder_release_date'] = array_key_exists('preorder_release_date', $data) ? $data['preorder_release_date'] : new \stdClass();
        $this->container['preorder_message'] = array_key_exists('preorder_message', $data) ? $data['preorder_message'] : new \stdClass();
        $this->container['is_preorder_only'] = array_key_exists('is_preorder_only', $data) ? $data['is_preorder_only'] : new \stdClass();
        $this->container['is_price_hidden'] = array_key_exists('is_price_hidden', $data) ? $data['is_price_hidden'] : new \stdClass();
        $this->container['price_hidden_label'] = array_key_exists('price_hidden_label', $data) ? $data['price_hidden_label'] : new \stdClass();
        $this->container['custom_url'] = array_key_exists('custom_url', $data) ? $data['custom_url'] : new \stdClass();
        $this->container['open_graph_type'] = array_key_exists('open_graph_type', $data) ? $data['open_graph_type'] : new \stdClass();
        $this->container['open_graph_title'] = array_key_exists('open_graph_title', $data) ? $data['open_graph_title'] : new \stdClass();
        $this->container['open_graph_description'] = array_key_exists('open_graph_description', $data) ? $data['open_graph_description'] : new \stdClass();
        $this->container['open_graph_use_meta_description'] = array_key_exists('open_graph_use_meta_description', $data) ? $data['open_graph_use_meta_description'] : new \stdClass();
        $this->container['open_graph_use_product_name'] = array_key_exists('open_graph_use_product_name', $data) ? $data['open_graph_use_product_name'] : new \stdClass();
        $this->container['open_graph_use_image'] = array_key_exists('open_graph_use_image', $data) ? $data['open_graph_use_image'] : new \stdClass();
    }
    ...
    {
        $allowed_values = array('none', 'product', 'variant');
        if (!in_array($inventory_tracking, $allowed_values)) {
    ...
    {
        $allowed_values = array('any', 'none', 'list');
        if (!in_array($gift_wrapping_options_type, $allowed_values)) {
    ...
    {
        $allowed_values = array('product', 'album', 'book', 'drink', 'food', 'game', 'movie', 'song', 'tv_show');
        if (!in_array($open_graph_type, $allowed_values)) {
