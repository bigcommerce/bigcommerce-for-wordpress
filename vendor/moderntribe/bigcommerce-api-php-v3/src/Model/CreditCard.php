...
class CreditCard implements ArrayAccess
{
    ...
    {
        $this->container['card_type'] = array_key_exists('card_type', $data) ? $data['card_type'] : new \stdClass();
        $this->container['card_iin'] = array_key_exists('card_iin', $data) ? $data['card_iin'] : new \stdClass();
        $this->container['card_last4'] = array_key_exists('card_last4', $data) ? $data['card_last4'] : new \stdClass();
    }
