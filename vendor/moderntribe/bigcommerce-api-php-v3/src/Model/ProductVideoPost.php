 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductVideoPost implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['video_id']) && (strlen($this->container['video_id']) > 25)) {
            $invalid_properties[] = "invalid value for 'video_id', the character length must be smaller than or equal to 25.";
        }

        if (!is_null($this->container['video_id']) && (strlen($this->container['video_id']) < 0)) {
    ...
    {
        if (!is_null($video_id) && (strlen($video_id) > 25)) {
        ...
        if (!is_null($video_id) && (strlen($video_id) < 0)) {
