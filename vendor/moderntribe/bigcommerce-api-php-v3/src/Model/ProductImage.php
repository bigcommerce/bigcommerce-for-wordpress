...
class ProductImage implements ArrayAccess
{
    ...
    {
        $this->container['is_thumbnail'] = array_key_exists('is_thumbnail', $data) ? $data['is_thumbnail'] : new \stdClass();
        ...
        $this->container['image_file'] = array_key_exists('image_file', $data) ? $data['image_file'] : new \stdClass();
        $this->container['url_zoom'] = array_key_exists('url_zoom', $data) ? $data['url_zoom'] : new \stdClass();
        $this->container['url_standard'] = array_key_exists('url_standard', $data) ? $data['url_standard'] : new \stdClass();
        $this->container['url_thumbnail'] = array_key_exists('url_thumbnail', $data) ? $data['url_thumbnail'] : new \stdClass();
        $this->container['url_tiny'] = array_key_exists('url_tiny', $data) ? $data['url_tiny'] : new \stdClass();
