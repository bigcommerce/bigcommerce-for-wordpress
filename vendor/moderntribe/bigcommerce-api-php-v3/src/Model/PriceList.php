...
class PriceList implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['active'] = array_key_exists('active', $data) ? $data['active'] : new \stdClass();
        ...
        $this->container['record_count'] = array_key_exists('record_count', $data) ? $data['record_count'] : new \stdClass();
    }
    ...
    /**
     * Sets record_count
     * @param int $record_count The number of `Price Records` associated with this `Price List`.
     * @return $this
     */
