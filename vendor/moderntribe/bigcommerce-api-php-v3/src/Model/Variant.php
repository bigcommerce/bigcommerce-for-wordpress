...
class Variant implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'sku' => 'string',
        'sku_id' => 'int',
        'option_values' => '\BigCommerce\Api\v3\Model\OptionValueVariant[]',
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['sku_id'] = array_key_exists('sku_id', $data) ? $data['sku_id'] : new \stdClass();
    ...
    /**
     * Gets option_values
     * @return \BigCommerce\Api\v3\Model\OptionValueVariant[]
     */
    ...
    /**
     * Sets option_values
     * @param \BigCommerce\Api\v3\Model\OptionValueVariant[] $option_values Array of option and option values IDs that make up this variant. Will be empty if the variant is the product's base variant.
     * @return $this
     */
