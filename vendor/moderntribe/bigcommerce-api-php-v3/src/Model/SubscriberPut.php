...
class SubscriberPut implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['first_name'] = array_key_exists('first_name', $data) ? $data['first_name'] : new \stdClass();
        $this->container['last_name'] = array_key_exists('last_name', $data) ? $data['last_name'] : new \stdClass();
        $this->container['source'] = array_key_exists('source', $data) ? $data['source'] : new \stdClass();
