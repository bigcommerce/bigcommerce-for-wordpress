...
class PriceRecord implements ArrayAccess
{
    ...
    {
        $this->container['price_list_id'] = array_key_exists('price_list_id', $data) ? $data['price_list_id'] : new \stdClass();
        $this->container['variant_id'] = array_key_exists('variant_id', $data) ? $data['variant_id'] : new \stdClass();
        ...
        $this->container['map_price'] = array_key_exists('map_price', $data) ? $data['map_price'] : new \stdClass();
