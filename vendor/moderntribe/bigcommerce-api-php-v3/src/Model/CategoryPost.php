...
/**
 * CategoryPost Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CategoryPost implements ArrayAccess
{
    /**
    ...
    {
        $this->container['parent_id'] = array_key_exists('parent_id', $data) ? $data['parent_id'] : new \stdClass();
        ...
        $this->container['views'] = array_key_exists('views', $data) ? $data['views'] : new \stdClass();
        ...
        $this->container['default_product_sort'] = array_key_exists('default_product_sort', $data) ? $data['default_product_sort'] : new \stdClass();
    ...
    {
        $allowed_values = array('use_store_settings', 'featured', 'newest', 'best_selling', 'alpha_asc', 'alpha_desc', 'avg_customer_review', 'price_asc', 'price_desc');
        if (!in_array($default_product_sort, $allowed_values)) {
