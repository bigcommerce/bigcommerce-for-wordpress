...
class Transaction implements ArrayAccess
{
    ...
    {
        $this->container['event'] = array_key_exists('event', $data) ? $data['event'] : new \stdClass();
        $this->container['method'] = array_key_exists('method', $data) ? $data['method'] : new \stdClass();
        $this->container['amount'] = array_key_exists('amount', $data) ? $data['amount'] : new \stdClass();
        $this->container['currency'] = array_key_exists('currency', $data) ? $data['currency'] : new \stdClass();
        $this->container['gateway'] = array_key_exists('gateway', $data) ? $data['gateway'] : new \stdClass();
        $this->container['gateway_transaction_id'] = array_key_exists('gateway_transaction_id', $data) ? $data['gateway_transaction_id'] : new \stdClass();
        $this->container['date_created'] = array_key_exists('date_created', $data) ? $data['date_created'] : new \stdClass();
        $this->container['test'] = array_key_exists('test', $data) ? $data['test'] : new \stdClass();
        $this->container['status'] = array_key_exists('status', $data) ? $data['status'] : new \stdClass();
        $this->container['fraud_review'] = array_key_exists('fraud_review', $data) ? $data['fraud_review'] : new \stdClass();
        $this->container['reference_transaction_id'] = array_key_exists('reference_transaction_id', $data) ? $data['reference_transaction_id'] : new \stdClass();
        $this->container['offline'] = array_key_exists('offline', $data) ? $data['offline'] : new \stdClass();
        $this->container['custom'] = array_key_exists('custom', $data) ? $data['custom'] : new \stdClass();
        $this->container['id'] = array_key_exists('id', $data) ? $data['id'] : new \stdClass();
        $this->container['order_id'] = array_key_exists('order_id', $data) ? $data['order_id'] : new \stdClass();
        $this->container['avs_result'] = array_key_exists('avs_result', $data) ? $data['avs_result'] : new \stdClass();
        $this->container['cvv_result'] = array_key_exists('cvv_result', $data) ? $data['cvv_result'] : new \stdClass();
        $this->container['credit_card'] = array_key_exists('credit_card', $data) ? $data['credit_card'] : new \stdClass();
        $this->container['gift_certificate'] = array_key_exists('gift_certificate', $data) ? $data['gift_certificate'] : new \stdClass();
        $this->container['store_credit'] = array_key_exists('store_credit', $data) ? $data['store_credit'] : new \stdClass();
    }
