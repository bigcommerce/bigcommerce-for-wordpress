...
class ConsignmentCouponDiscount implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Consignment Coupon Discount';
    ...
    /**
     * Sets code
     * @param string $code Coupon code that applied this discount
     * @return $this
     */
