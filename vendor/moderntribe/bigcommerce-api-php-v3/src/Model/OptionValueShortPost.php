...
/**
 * OptionValueShortPost Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     BigCommerce\Api\v3
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OptionValueShortPost implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'OptionValueShortPost';
     ...
     * @param string $option_display_name The name of the option to be created on POST.
     * @return $this
     */
    ...
    /**
     * Sets label
     * @param string $label The label of the option value to be created on POST.
     * @return $this
     */
