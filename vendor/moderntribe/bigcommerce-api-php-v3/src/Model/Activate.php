...
class Activate implements ArrayAccess
{
    ...
    {
        $this->container['variation_id'] = array_key_exists('variation_id', $data) ? $data['variation_id'] : new \stdClass();
        $this->container['which'] = array_key_exists('which', $data) ? $data['which'] : new \stdClass();
    }
    ...
    {
        $allowed_values = array('original', 'last_activated', 'last_created');
        if (!in_array($which, $allowed_values)) {
