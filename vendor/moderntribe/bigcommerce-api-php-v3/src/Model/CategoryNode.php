...
class CategoryNode implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'is_visible' => 'bool',
        'url' => 'string',
        'children' => '\BigCommerce\Api\v3\Model\CategoryNode[]'
    );
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['children'] = array_key_exists('children', $data) ? $data['children'] : new \stdClass();
    }
    ...
    /**
     * Gets children
     * @return \BigCommerce\Api\v3\Model\CategoryNode[]
     */
    ...
    /**
     * Sets children
     * @param \BigCommerce\Api\v3\Model\CategoryNode[] $children The list of children of the category.
     * @return $this
     */
