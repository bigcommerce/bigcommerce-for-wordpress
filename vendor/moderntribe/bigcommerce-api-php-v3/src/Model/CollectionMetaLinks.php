...
/**
 * CollectionMetaLinks Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CollectionMetaLinks implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CollectionMeta_links';
    ...
    {
        $this->container['previous'] = array_key_exists('previous', $data) ? $data['previous'] : new \stdClass();
        $this->container['current'] = array_key_exists('current', $data) ? $data['current'] : new \stdClass();
        $this->container['next'] = array_key_exists('next', $data) ? $data['next'] : new \stdClass();
    }
