...
class ProductVideo implements ArrayAccess
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['video_id'] = array_key_exists('video_id', $data) ? $data['video_id'] : new \stdClass();
        $this->container['product_id'] = array_key_exists('product_id', $data) ? $data['product_id'] : new \stdClass();
        $this->container['length'] = array_key_exists('length', $data) ? $data['length'] : new \stdClass();
    }
