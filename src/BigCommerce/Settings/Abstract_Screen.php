...
abstract class Abstract_Screen {
	...
	protected $plugin_configured = false;
	 ...
	 *
	 * @param bool   $plugin_configured A flag indicating if the plugin has been fully configured
	 * @param string $assets_url        Path to the plugin assets directory
	 */
	public function __construct( $plugin_configured, $assets_url ) {
		if ( empty( static::NAME ) ) {
			throw new \LogicException( 'Classes extending Abstract_Screen must have the NAME constant set to a non-empty value' );
		}
		$this->plugin_configured = $plugin_configured;
	...
	public function render_settings_page() {
		ob_start();
		$this->before_form();
		printf( '<form action="%s" method="post" class="bc-settings-form bc-settings-form--%s">', esc_url( admin_url( 'options.php' ) ), static::NAME );
