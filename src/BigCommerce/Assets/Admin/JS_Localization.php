	...
	public function get_data() {
		$js_i18n_array = [
			...
			'messages'   => [
				...
				'diagnostics_error_header'    => __( 'Diagnostics Unavailable', 'bigcommerce' ),
				'diagnostics_error_message'   => __( 'There was an error trying to retrieve information about your site. Please try again.', 'bigcommerce' ),
			],
			'operations' => [
