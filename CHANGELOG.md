...
### Fixed
- Resolved issue with categories import on Multi Storefront Store. During import, some categories could disappear from WordPress Store or be completely deleted due to the missing category tree on the WordPress channel.  To prevent such a situation fallback to retrieving the default categories list is added
- 
## [5.0.3]
