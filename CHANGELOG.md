...
- Delete all channels on plugin uninstall so fresh channel list is pulled when reinstalling and connecting to a new store
...
- Fixed top/bottom banners set for the homepage don’t show up on 2017 theme
